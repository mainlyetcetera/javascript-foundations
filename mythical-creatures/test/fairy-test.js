...
describe('Fairy', () => {
  ...
  it('should only steal infants when feeling vengeful', () => {
    ...
    const secondInfant = { name: 'Hannah', eyes: 'Brown', disposition: 'Kind' };
    ...
    fairy.provoke();
    let captured = fairy.replaceInfant(secondInfant);
    assert.deepEqual(captured, { name: 'Hannah', eyes: 'Brown', disposition: 'Malicious' });
  });
  ...
  it('should calm down after stealing three infants', () => {
    ...
    // console.log(firstInfant, secondInfant, thirdInfant);
